    ...
    <nav className="text-black border border-gray-600 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 relative">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link href="/componentfeature/blogstwo" className="text-sm hover:underline">Listing</Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-gray-100 text-black p-4 space-y-2 absolute w-full left-0 top-16 z-50 flex flex-col">
          ...
          <Link href="/componentfeature/blogstwo" className="py-2 border-b flex items-center"><List className='mr-2' /> Listing</Link>
